 ...
 *
 */
#ifndef OCALITEINT8SENSOR_H
#define OCALITEINT8SENSOR_H
 ...
 */
#define OCA_INT8_SENSOR_CLASSID      OCA_BASIC_SENSOR_CLASSID,static_cast< ::OcaUint16>(2)
 ...
 * Basic Int8 sensor.
 */
class OcaLiteInt8Sensor : public ::OcaLiteBasicSensor
{
public:
     ...
     */
    ::OcaLiteStatus GetReading(::OcaInt8& reading, ::OcaInt8& minReading, ::OcaInt8& maxReading) const;
...
protected:
     ...
     */
    OcaLiteInt8Sensor(::OcaONo objectNumber, ::OcaBoolean lockable, const ::OcaLiteString& role, const ::OcaLiteList< ::OcaLitePort>& ports, ::OcaInt8 minReading, ::OcaInt8 maxReading);
     ...
     */
    virtual ::OcaLiteStatus GetReadingValue(::OcaInt8& reading) const = 0;
     ...
     * @return Indicates whether the operation succeeded.
     */
    ::OcaLiteStatus GetLimits(::OcaInt8& minReading, ::OcaInt8& maxReading) const;
     ...
     */
    void ReadingChanged(::OcaInt8 reading);

private:
	/** Lower limit of the reading property */
    ::OcaInt8                               m_minReading;
    /** Upper limit of the reading property */
    ::OcaInt8                               m_maxReading;

    /** private copy constructor, no copying of object allowed */
    OcaLiteInt8Sensor(const ::OcaLiteInt8Sensor&);
    /** private assignment operator, no assignment of object allowed */
    ::OcaLiteInt8Sensor& operator=(const ::OcaLiteInt8Sensor&);
};

#endif // OCALITEINT8SENSOR_H
