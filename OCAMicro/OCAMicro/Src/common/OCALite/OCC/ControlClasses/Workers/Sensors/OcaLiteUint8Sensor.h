 ...
 *
 */
#ifndef OCALITEUINT8SENSOR_H
#define OCALITEUINT8SENSOR_H
 ...
 */
#define OCA_UINT8_SENSOR_CLASSID      OCA_BASIC_SENSOR_CLASSID,static_cast< ::OcaUint16>(6)
 ...
 * Basic Uint8 sensor.
 */
class OcaLiteUint8Sensor : public ::OcaLiteBasicSensor
{
public:
     ...
     */
    ::OcaLiteStatus GetReading(::OcaUint8& reading, ::OcaUint8& minReading, ::OcaUint8& maxReading) const;
...
protected:
     ...
     */
    OcaLiteUint8Sensor(::OcaONo objectNumber, ::OcaBoolean lockable, const ::OcaLiteString& role, const ::OcaLiteList< ::OcaLitePort>& ports, ::OcaUint8 minReading, ::OcaUint8 maxReading);
     ...
     */
    virtual ::OcaLiteStatus GetReadingValue(::OcaUint8& reading) const = 0;
     ...
     * @return Indicates whether the operation succeeded.
     */
    ::OcaLiteStatus GetLimits(::OcaUint8& minReading, ::OcaUint8& maxReading) const;
     ...
     */
    void ReadingChanged(::OcaUint8 reading);

private:
    /** Lower limit of the reading property */
    ::OcaUint8                               m_minReading;
    /** Upper limit of the reading property */
    ::OcaUint8                               m_maxReading;

    /** private copy constructor, no copying of object allowed */
    OcaLiteUint8Sensor(const ::OcaLiteUint8Sensor&);
    /** private assignment operator, no assignment of object allowed */
    ::OcaLiteUint8Sensor& operator=(const ::OcaLiteUint8Sensor&);
};

#endif // OCALITEUINT8SENSOR_H
