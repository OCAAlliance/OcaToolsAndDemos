...
#include "OcaLiteTemperatureSensor.h"

// ---- Helper types and constants ----

static const ::OcaUint16        classID[]   = {OCA_TEMPERATURE_SENSOR_CLASSID};
const ::OcaLiteClassID              OcaLiteTemperatureSensor::CLASS_ID(static_cast< ::OcaUint16>(sizeof(classID) / sizeof(classID[0])), classID);
...
::OcaLiteStatus OcaLiteTemperatureSensor::GetReading(::OcaTemperature& reading, ::OcaTemperature& minReading, ::OcaTemperature& maxReading) const
{
...
::OcaClassVersionNumber OcaLiteTemperatureSensor::GetClassVersion() const
{
    return static_cast< ::OcaClassVersionNumber>(static_cast<int>(OcaLiteSensor::GetClassVersion()) + CLASS_VERSION_INCREMENT);
}

void OcaLiteTemperatureSensor::ReadingChanged(::OcaTemperature reading)
{
    ::OcaLitePropertyID propertyID(CLASS_ID.GetFieldCount(), static_cast< ::OcaUint16>(OCA_PROP_READING));
    ::OcaLitePropertyChangedEventData< ::OcaTemperature> eventData(GetObjectNumber(),
                                                               propertyID,
                                                               reading,
