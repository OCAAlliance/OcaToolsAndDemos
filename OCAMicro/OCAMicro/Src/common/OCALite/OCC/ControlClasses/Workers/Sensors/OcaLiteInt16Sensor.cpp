...
#include "OcaLiteInt16Sensor.h"

// ---- Helper types and constants ----

static const ::OcaUint16        classID[]   = {OCA_INT16_SENSOR_CLASSID};
const ::OcaLiteClassID          OcaLiteInt16Sensor::CLASS_ID(static_cast< ::OcaUint16>(sizeof(classID) / sizeof(classID[0])), classID);
...
OcaLiteInt16Sensor::OcaLiteInt16Sensor(::OcaONo objectNumber,
                                           ::OcaBoolean lockable,
...
::OcaLiteStatus OcaLiteInt16Sensor::GetReading(::OcaInt16& reading, ::OcaInt16& minReading, ::OcaInt16& maxReading) const
{
     ...
     */
::OcaLiteStatus  OcaLiteInt16Sensor::GetLimits(::OcaInt16& minReading, ::OcaInt16& maxReading) const
{
...
::OcaLiteStatus OcaLiteInt16Sensor::Execute(const ::IOcaLiteReader& reader, const ::IOcaLiteWriter& writer, ::OcaSessionID sessionID, const ::OcaLiteMethodID& methodID,
                        ...
                        (0 == numberOfParameters))
                    {
                        ...
                        if (OCASTATUS_OK == rc)
                        {
                            ::OcaUint32 responseSize(::GetSizeValue< ::OcaUint8>(static_cast< ::OcaUint8>(3), writer) +
                                                     ::GetSizeValue< ::OcaInt16>(reading, writer) +
                                                     ::GetSizeValue< ::OcaInt16>(minReading, writer) +
                                                     ::GetSizeValue< ::OcaInt16>(maxReading, writer));
                            responseBuffer = ::OcaLiteCommandHandler::GetInstance().GetResponseBuffer(responseSize);
                            if (NULL != responseBuffer)
                            {
                                ::OcaUint8* pResponse(responseBuffer);
                                writer.Write(static_cast< ::OcaUint8>(3/*NrParameters*/), &pResponse);
                                ::MarshalValue< ::OcaInt16>(reading, &pResponse, writer);
                                ::MarshalValue< ::OcaInt16>(minReading, &pResponse, writer);
                                ::MarshalValue< ::OcaInt16>(maxReading, &pResponse, writer);
