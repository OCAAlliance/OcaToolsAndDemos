...
#include "OcaLiteUint32Sensor.h"

// ---- Helper types and constants ----

static const ::OcaUint16        classID[]   = {OCA_UINT32_SENSOR_CLASSID};
const ::OcaLiteClassID          OcaLiteUint32Sensor::CLASS_ID(static_cast< ::OcaUint16>(sizeof(classID) / sizeof(classID[0])), classID);
...
OcaLiteUint32Sensor::OcaLiteUint32Sensor(::OcaONo objectNumber,
                                           ::OcaBoolean lockable,
                                           const ::OcaLiteString& role,
                                           const ::OcaLiteList< ::OcaLitePort>& ports,
                                           ::OcaUint32 minReading,
                                           ::OcaUint32 maxReading)
...
::OcaLiteStatus OcaLiteUint32Sensor::GetReading(::OcaUint32& reading, ::OcaUint32& minReading, ::OcaUint32& maxReading) const
{
     ...
     */
::OcaLiteStatus  OcaLiteUint32Sensor::GetLimits(::OcaUint32& minReading, ::OcaUint32& maxReading) const
{
...
::OcaLiteStatus OcaLiteUint32Sensor::Execute(const ::IOcaLiteReader& reader, const ::IOcaLiteWriter& writer, ::OcaSessionID sessionID, const ::OcaLiteMethodID& methodID,
                        ...
                        (0 == numberOfParameters))
                    {
                        ...
                        if (OCASTATUS_OK == rc)
                        {
                            ::OcaUint32 responseSize(::GetSizeValue< ::OcaUint8>(static_cast< ::OcaUint8>(3), writer) +
                                                     ::GetSizeValue< ::OcaUint32>(reading, writer) +
                                                     ::GetSizeValue< ::OcaUint32>(minReading, writer) +
                                                     ::GetSizeValue< ::OcaUint32>(maxReading, writer));
                            responseBuffer = ::OcaLiteCommandHandler::GetInstance().GetResponseBuffer(responseSize);
                            if (NULL != responseBuffer)
                            {
                                ::OcaUint8* pResponse(responseBuffer);
                                writer.Write(static_cast< ::OcaUint8>(3/*NrParameters*/), &pResponse);
                                ::MarshalValue< ::OcaUint32>(reading, &pResponse, writer);
                                ::MarshalValue< ::OcaUint32>(minReading, &pResponse, writer);
                                ::MarshalValue< ::OcaUint32>(maxReading, &pResponse, writer);
