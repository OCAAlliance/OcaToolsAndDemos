...
#include "OcaLiteUint16Sensor.h"

// ---- Helper types and constants ----

static const ::OcaUint16        classID[]   = {OCA_UINT16_SENSOR_CLASSID};
const ::OcaLiteClassID          OcaLiteUint16Sensor::CLASS_ID(static_cast< ::OcaUint16>(sizeof(classID) / sizeof(classID[0])), classID);
...
OcaLiteUint16Sensor::OcaLiteUint16Sensor(::OcaONo objectNumber,
                                           ::OcaBoolean lockable,
                                           const ::OcaLiteString& role,
                                           const ::OcaLiteList< ::OcaLitePort>& ports,
                                           ::OcaUint16 minReading,
                                           ::OcaUint16 maxReading)
...
::OcaLiteStatus OcaLiteUint16Sensor::GetReading(::OcaUint16& reading, ::OcaUint16& minReading, ::OcaUint16& maxReading) const
{
     ...
     */
::OcaLiteStatus  OcaLiteUint16Sensor::GetLimits(::OcaUint16& minReading, ::OcaUint16& maxReading) const
{
...
::OcaLiteStatus OcaLiteUint16Sensor::Execute(const ::IOcaLiteReader& reader, const ::IOcaLiteWriter& writer, ::OcaSessionID sessionID, const ::OcaLiteMethodID& methodID,
                        ...
                        (0 == numberOfParameters))
                    {
                        ...
                        if (OCASTATUS_OK == rc)
                        {
                            ::OcaUint32 responseSize(::GetSizeValue< ::OcaUint8>(static_cast< ::OcaUint8>(3), writer) +
                                                     ::GetSizeValue< ::OcaUint16>(reading, writer) +
                                                     ::GetSizeValue< ::OcaUint16>(minReading, writer) +
                                                     ::GetSizeValue< ::OcaUint16>(maxReading, writer));
                            responseBuffer = ::OcaLiteCommandHandler::GetInstance().GetResponseBuffer(responseSize);
                            if (NULL != responseBuffer)
                            {
                                ::OcaUint8* pResponse(responseBuffer);
                                writer.Write(static_cast< ::OcaUint8>(3/*NrParameters*/), &pResponse);
                                ::MarshalValue< ::OcaUint16>(reading, &pResponse, writer);
                                ::MarshalValue< ::OcaUint16>(minReading, &pResponse, writer);
                                ::MarshalValue< ::OcaUint16>(maxReading, &pResponse, writer);
...
::OcaClassVersionNumber OcaLiteUint16Sensor::GetClassVersion() const
{
    return static_cast< ::OcaClassVersionNumber>(static_cast<int>(OcaLiteBasicSensor::GetClassVersion()) + CLASS_VERSION_INCREMENT);
}

void OcaLiteUint16Sensor::ReadingChanged(::OcaUint16 reading)
{
