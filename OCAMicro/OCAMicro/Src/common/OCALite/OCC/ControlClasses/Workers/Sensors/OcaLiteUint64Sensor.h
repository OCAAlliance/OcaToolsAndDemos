 ...
 *
 */
#ifndef OCALITEUINT64SENSOR_H
#define OCALITEUINT64SENSOR_H
 ...
 */
#define OCA_UINT64_SENSOR_CLASSID      OCA_BASIC_SENSOR_CLASSID,static_cast< ::OcaUint16>(9)
 ...
 * Basic Uint64 sensor.
 */
class OcaLiteUint64Sensor : public ::OcaLiteBasicSensor
{
public:
     ...
     */
    ::OcaLiteStatus GetReading(::OcaUint64& reading, ::OcaUint64& minReading, ::OcaUint64& maxReading) const;
...
protected:
     ...
     */
    OcaLiteUint64Sensor(::OcaONo objectNumber, ::OcaBoolean lockable, const ::OcaLiteString& role, const ::OcaLiteList< ::OcaLitePort>& ports, ::OcaUint64 minReading, ::OcaUint64 maxReading);
     ...
     */
    virtual ::OcaLiteStatus GetReadingValue(::OcaUint64& reading) const = 0;
     ...
     * @return Indicates whether the operation succeeded.
     */
    ::OcaLiteStatus GetLimits(::OcaUint64& minReading, ::OcaUint64& maxReading) const;
     ...
     */
    void ReadingChanged(::OcaUint64 reading);

private:
    /** Lower limit of the reading property */
    ::OcaUint64                               m_minReading;
    /** Upper limit of the reading property */
    ::OcaUint64                               m_maxReading;

    /** private copy constructor, no copying of object allowed */
    OcaLiteUint64Sensor(const ::OcaLiteUint64Sensor&);
    /** private assignment operator, no assignment of object allowed */
    ::OcaLiteUint64Sensor& operator=(const ::OcaLiteUint64Sensor&);
};

#endif // OCALITEUINT64SENSOR_H
