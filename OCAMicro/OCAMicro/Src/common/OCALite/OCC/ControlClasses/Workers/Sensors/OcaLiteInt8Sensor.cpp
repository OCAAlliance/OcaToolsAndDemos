...
#include "OcaLiteInt8Sensor.h"

// ---- Helper types and constants ----

static const ::OcaUint16        classID[]   = {OCA_INT8_SENSOR_CLASSID};
...
OcaLiteInt8Sensor::OcaLiteInt8Sensor(::OcaONo objectNumber,
                                           ::OcaBoolean lockable,
...
::OcaLiteStatus OcaLiteInt8Sensor::GetReading(::OcaInt8& reading, ::OcaInt8& minReading, ::OcaInt8& maxReading) const
{
     ...
     */
::OcaLiteStatus  OcaLiteInt8Sensor::GetLimits(::OcaInt8& minReading, ::OcaInt8& maxReading) const
{
...
::OcaLiteStatus OcaLiteInt8Sensor::Execute(const ::IOcaLiteReader& reader, const ::IOcaLiteWriter& writer, ::OcaSessionID sessionID, const ::OcaLiteMethodID& methodID,
