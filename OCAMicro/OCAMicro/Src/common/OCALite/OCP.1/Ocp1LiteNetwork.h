 ...
 *
 */
#ifndef OCP1LITENETWORK_H
#define OCP1LITENETWORK_H
...
public:
     ...
     */
    Ocp1LiteNetwork(::OcaONo objectNumber,
                    ::OcaBoolean lockable,
...
private:
    /** The maximum length of the pending connections queue for sockets */
    static const UINT8 SOCKETBACKLOG;

    /** Map with connected controllers. Key is sessionId */
    typedef std::map< ::OcaSessionID, ::Ocp1LiteSocketConnection*> OcaSocketList;
     ...
     */
    ::Ocp1LiteSocketConnection* FindSocketConnection(::OcaSessionID sessionID);
    ...
    Ocp1LiteNetwork(const ::Ocp1LiteNetwork&);
    /** private assignment operator, no assignment of object allowed */
    Ocp1LiteNetwork& operator=(const ::Ocp1LiteNetwork&);
};

#endif // OCP1LITENETWORK_H
